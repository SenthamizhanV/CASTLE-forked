...
for line in csv_file:
    ...
    if (line[10]=="bigg"):
        for line1 in csv_file1:
            jsl.append(line1[0])
            table_code=table_code+"<tr><td><a href='"+line[8]+"/reactions/"+line1[0]+"' target='blank'><center><u><font color='black'>"+line1[0]+"</font></u></center></a></td></tr>"
    elif (line[10]=="vmh"):
        for line1 in csv_file1:
            jsl.append(line1[0])
            table_code=table_code+"<tr><td><a href='https://vmh.life/#reaction/"+line1[0]+"' target='blank'><center><u><font color='black'>"+line1[0]+"</font></u></center></a></td></tr>"
    #print("jsl")
    #print(jsl)
#a = "../assets/img/s.jpg"

    #print(line[0])
    filename='Single_Lethal_Reaction/'+line[0]+'.html' 
    #print(filename)
    f = open(filename,'w')
