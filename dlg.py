...
for line in csv_file:
    ...
    if (line[10]=="bigg"):
        for line1 in csv_file1:
            ...
            table_code=table_code+"<tr><td><a href='"+line[8]+"/genes/"+line1[0]+"' target='blank'><center><u><font color='black'>"+line1[0]+"</font></u></center></a></td><td><a href='"+line[8]+"/genes/"+line1[1]+"' target='blank'><center><u><font color='black'>"+line1[1]+"</font></u></center></a></td></tr>"
    elif (line[10]=="vmh"):
        for line1 in csv_file1:
           
            table_code=table_code+"<tr><td><a href='https://vmh.life/#microbegene/"+line1[0]+"' target='blank'><center><u><font color='black'>"+line1[0]+"</font></u></center></a></td><td><a href='https://vmh.life/#microbegene/"+line1[1]+"' target='blank'><center><u><font color='black'>"+line1[1]+"</font></u></center></a></td></tr>"
   
#a = "../assets/img/s.jpg"

    #print(line[0])
    filename='Double_Lethal_Gene/'+line[0]+'.html' 
    #print(filename)
    f = open(filename,'w')
