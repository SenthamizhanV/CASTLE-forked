...
for line in csv_file:
    ...
    if (line[10]=="bigg"):
        for line1 in csv_file1:
            ...
            table_code=table_code+"<tr><td><a href='"+line[8]+"/reactions/"+line1[0]+"' target='blank'><center><u><font color='black'>"+line1[0]+"</font></u></center></a></td><td><a href='"+line[8]+"/reactions/"+line1[1]+"' target='blank'><center><u><font color='black'>"+line1[1]+"</font></u></center></a></td></tr>"
    elif (line[10]=="vmh"):
        for line1 in csv_file1:
           
            table_code=table_code+"<tr><td><a href='https://vmh.life/#reaction/"+line1[0]+"' target='blank'><center><u><font color='black'>"+line1[0]+"</font></u></center></a></td><td><a href='https://vmh.life/#reaction/"+line1[1]+"' target='blank'><center><u><font color='black'>"+line1[1]+"</font></u></center></a></td></tr>"
   
#a = "../assets/img/s.jpg"

    #print(line[0])
    filename='Double_Lethal_Reaction/'+line[0]+'.html' 
    #print(filename)
    f = open(filename,'w')
...
.footer {{
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" background="../images/body3.jpg">
            ...
            <div class="container">
              ...
              <div>
               ...
               <font size="8" color="marooon"><b><center>{}</center></b></font>
                <font size="4" color="darkblue"><b><center>DOUBLE LETHAL REACTIONS</center></b></font><br>
